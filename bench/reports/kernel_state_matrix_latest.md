...
| recurrent_gated_delta_rule | wave3 | blocked by PTODSL surface | no | n/a | ok | blocked | n/a | [report](bench/generated/attention/recurrent_gated_delta_rule/report.json) |
|  |  | gap ids: `ptodsl-recurrent-state-update-primitives` |  |  |  |  |  |  |
...
| ring_attention_update | wave3 | blocked by host baseline/runtime gap | no | n/a | blocked | ok | n/a | [report](bench/generated/attention/ring_attention_update/report.json) |
...
|  |  | gap ids: `ptodsl-routing-sort-primitives` |  |  |  |  |  |  |
| attention_update | wave3 | green + tile-first | no | n/a | ok | ok | 37.6%..38.3% | [report](bench/generated/attention/attention_update/report.json) |
| incre_flash_attention | wave3 | green + tile-first | no | n/a | ok | ok | 24.1%..27.8% | [report](bench/generated/attention/incre_flash_attention/report.json) |
| prompt_flash_attention | wave3 | green + tile-first | no | n/a | ok | ok | 71.2%..75.1% | [report](bench/generated/attention/prompt_flash_attention/report.json) |
