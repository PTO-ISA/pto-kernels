...
| moe_finalize_routing_v2_grad | wave2 | blocked by PTO correctness gap | yes | 8 blocks, all=True | blocked | ok | n/a | [report](bench/generated/moe/moe_finalize_routing_v2_grad/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/moe/moe_finalize_routing_v2_grad/kernel.py:load_scalarx3; python/pto_kernels/ops/moe/moe_finalize_routing_v2_grad/kernel.py:store_scalarx1` |  |  |  |  |  |  |
|  |  | gap ids: `ptodsl-routing-sort-primitives, pto-correctness-grad-scales-reduction` |  |  |  |  |  |  |
