...
| flash_attention_score | wave3 | blocked by PTOAS lowering | yes | n/a | ok | blocked | n/a | [report](bench/generated/attention/flash_attention_score/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/attention/common.py:scalar_selectx2` |  |  |  |  |  |  |
|  |  | gap ids: `ptoas-section-cube-scf-if-terminator` |  |  |  |  |  |  |
| fused_infer_attention_score | wave3 | blocked by PTOAS lowering | yes | n/a | ok | blocked | n/a | [report](bench/generated/attention/fused_infer_attention_score/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/attention/common.py:scalar_selectx2` |  |  |  |  |  |  |
|  |  | gap ids: `ptoas-section-cube-scf-if-terminator, ptodsl-paged-cache-surface` |  |  |  |  |  |  |
...
|  |  | scalar matches: `python/pto_kernels/ops/ffn/common.py:scalar_selectx2` |  |  |  |  |  |  |
| grouped_matmul | wave1 | green but scalar-heavy | yes | n/a | ok | ok | 41.6%..42.0% | [report](bench/generated/gmm/grouped_matmul/report.json) |
...
| moe_gating_top_k_softmax | wave2 | green but scalar-heavy | yes | n/a | ok | ok | 30.0%..34.7% | [report](bench/generated/moe/moe_gating_top_k_softmax/report.json) |
