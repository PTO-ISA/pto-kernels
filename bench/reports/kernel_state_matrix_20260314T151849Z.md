...
| flash_attention_score | wave3 | green but scalar-heavy | yes | n/a | ok | ok | 34.0%..37.9% | [report](bench/generated/attention/flash_attention_score/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/attention/common.py:scalar_selectx2` |  |  |  |  |  |  |
|  |  | gap ids: `ptoas-ptodsl-trowexpandexpdif-surface` |  |  |  |  |  |  |
| fused_infer_attention_score | wave3 | green but scalar-heavy | yes | n/a | ok | ok | 37.3%..42.8% | [report](bench/generated/attention/fused_infer_attention_score/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/attention/common.py:scalar_selectx2` |  |  |  |  |  |  |
|  |  | gap ids: `ptodsl-fused-infer-scaled-parity, ptoas-ptodsl-trowexpandexpdif-surface` |  |  |  |  |  |  |
