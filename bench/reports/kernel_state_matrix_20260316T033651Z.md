...
| flash_attention_score | wave3 | blocked by PTOAS lowering | yes | n/a | blocked | blocked | n/a | [report](bench/generated/attention/flash_attention_score/report.json) |
...
|  |  | scalar matches: `python/pto_kernels/ops/ffn/common.py:scalar_selectx2` |  |  |  |  |  |  |
| moe_finalize_routing | wave2 | green but scalar-heavy | yes | n/a | ok | ok | 34.9%..35.5% | [report](bench/generated/moe/moe_finalize_routing/report.json) |
...
|  |  | gap ids: `ptodsl-routing-sort-primitives` |  |  |  |  |  |  |
| fused_infer_attention_score | wave3 | green but scalar-heavy | yes | n/a | ok | ok | 32.8%..40.2% | [report](bench/generated/attention/fused_infer_attention_score/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/attention/common.py:scalar_selectx2` |  |  |  |  |  |  |
...
|  |  | gap ids: `ptodsl-rope-generalization, ptodsl-vector-queue-pipeline-surface` |  |  |  |  |  |  |
| moe_init_routing | wave2 | green + tile-first | no | n/a | ok | ok | 16.2%..16.7% | [report](bench/generated/moe/moe_init_routing/report.json) |
|  |  | gap ids: `ptodsl-routing-sort-primitives` |  |  |  |  |  |  |
...
| incre_flash_attention | wave3 | green + tile-first | no | n/a | ok | ok | 23.0%..25.1% | [report](bench/generated/attention/incre_flash_attention/report.json) |
| prompt_flash_attention | wave3 | green + tile-first | no | n/a | ok | ok | 71.5%..86.9% | [report](bench/generated/attention/prompt_flash_attention/report.json) |
