...
| fused_infer_attention_score | wave3 | blocked by pto-isa/backend capability | yes | n/a | ok | blocked | n/a | [report](bench/generated/attention/fused_infer_attention_score/report.json) |
|  |  | scalar matches: `python/pto_kernels/ops/attention/common.py:scalar_selectx2` |  |  |  |  |  |  |
|  |  | gap ids: `ptoisa-a2a3-tile-runtime-api` |  |  |  |  |  |  |
