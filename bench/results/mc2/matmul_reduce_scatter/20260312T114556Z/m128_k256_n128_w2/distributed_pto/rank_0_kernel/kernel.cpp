...
__global__ AICORE void matmul_reduce_scatter_local_mm(__gm__ half* v1, __gm__ half* v2, __gm__ half* v3) {
  ...
  for (size_t v23 = v21; v23 < ((size_t) v14); v23 += v22) {
    ...
    for (size_t v30 = v21; v30 < ((size_t) v11); v30 += v22) {
      ...
      GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<8192, 8192, 8192, 256, 1>, pto::Layout::ND> v35 = GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<8192, 8192, 8192, 256, 1>, pto::Layout::ND>(v2 + (v10 + (unsigned) v24 * (unsigned) v15 + (unsigned) v32 * (unsigned) v17), v33, v34);
