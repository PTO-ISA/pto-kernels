...
__global__ AICORE void matmul_reduce_scatter_local_mm(__gm__ half* v1, __gm__ half* v2, __gm__ half* v3) {
  ...
  for (size_t v22 = v20; v22 < v21; v22 += v21) {
    ...
    for (size_t v29 = v20; v29 < ((size_t) v11); v29 += v21) {
      ...
      GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<8192, 8192, 8192, 256, 1>, pto::Layout::ND> v34 = GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<8192, 8192, 8192, 256, 1>, pto::Layout::ND>(v2 + (v10 + (unsigned) v23 * (unsigned) v14 + (unsigned) v31 * (unsigned) v16), v32, v33);
