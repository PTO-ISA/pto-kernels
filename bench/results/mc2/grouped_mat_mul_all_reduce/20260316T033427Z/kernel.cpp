...
__global__ AICORE void grouped_mat_mul_all_reduce_local(__gm__ half* v1, __gm__ half* v2, __gm__ half* v3) {
  ...
  if (v23 < v11) {
    ...
    for (int32_t v44 = v19; v44 < v12; v44 += v18) {
      int32_t v45 = (int32_t) ((uint32_t) v44 + (uint32_t) (v23 / v11));
      if (v45 < v12) {
        int32_t v46 = (int32_t) ((uint32_t) v45 * (uint32_t) v15);
        int32_t v47 = (int32_t) ((uint32_t) (v23 % v11) * (uint32_t) v15);
        ...
        for (int32_t v48 = v19; v48 < v13; v48 += v18) {
          ...
          GlobalTensor<half, pto::Shape<1, 1, 1, 32, 64>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND> v52 = GlobalTensor<half, pto::Shape<1, 1, 1, 32, 64>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND>(v2 + (v10 + (unsigned) v46 * (unsigned) v16 + (unsigned) v49 * (unsigned) v18), v50, v51);
          pto::Shape<1, 1, 1, 64, 32> v53 = pto::Shape<1, 1, 1, 64, 32>();
          pto::Stride<8192, 8192, 8192, 128, 1> v54 = pto::Stride<8192, 8192, 8192, 128, 1>();
          GlobalTensor<half, pto::Shape<1, 1, 1, 64, 32>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND> v55 = GlobalTensor<half, pto::Shape<1, 1, 1, 64, 32>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND>(v3 + (v10 + (unsigned) v49 * (unsigned) v16 + (unsigned) v47 * (unsigned) v18), v53, v54);
        ...
        GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND> v58 = GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND>(v1 + (v10 + (unsigned) v46 * (unsigned) v16 + (unsigned) v47 * (unsigned) v18), v56, v57);
