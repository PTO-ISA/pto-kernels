...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  TASSIGN(v32, v11);
  Tile<TileType::Vec, half, 1, 64, BLayout::RowMajor, 1, 1, SLayout::NoneBox, 512, PadValue::Null> v33;
  ...
  for (int32_t v40 = v18; v40 < ((uint32_t) v19 < (uint32_t) v6 ? v19 : v6); v40 += v7) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v43 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v1 + (v4 + (unsigned) v40 * (unsigned) v6 + v4 * (unsigned) v7), v41, v42);
