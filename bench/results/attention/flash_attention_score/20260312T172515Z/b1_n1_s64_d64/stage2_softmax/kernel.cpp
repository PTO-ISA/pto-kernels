...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  TASSIGN(v22, v10);
  Tile<TileType::Vec, half, 1, 64, BLayout::RowMajor, 1, 1, SLayout::NoneBox, 512, PadValue::Null> v23;
  TASSIGN(v23, v11);
  ...
  for (size_t v25 = (size_t) v18; v25 < ((size_t) ((uint32_t) v19 < (uint32_t) v6 ? v19 : v6)); v25 += (size_t) v7) {
    pto::Shape<1, 1, 1, 1, 64> v26 = pto::Shape<1, 1, 1, 1, 64>();
    pto::Stride<64, 64, 64, 64, 1> v27 = pto::Stride<64, 64, 64, 64, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v28 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v1 + (v4 + (unsigned) ((int32_t) v25) * (unsigned) v6 + v4 * (unsigned) v7), v26, v27);
