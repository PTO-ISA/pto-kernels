...
__global__ AICORE void recurrent_state_key_proj(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3) {
  ...
  TASSIGN(v27, v29);
  Tile<TileType::Mat, bfloat16_t, 1, 16, BLayout::RowMajor, 1, 16, SLayout::NoneBox, 512, PadValue::Null> v30;
  TASSIGN(v30, v14);
  Tile<TileType::Mat, bfloat16_t, 1, 16, BLayout::RowMajor, 1, 16, SLayout::NoneBox, 512, PadValue::Null> v31;
  __cbuf__ bfloat16_t* v32 = v30.data();
  uint64_t v33 = reinterpret_cast<uint64_t>(v32);
  TASSIGN(v31, v33);
  Tile<TileType::Right, bfloat16_t, 1, 16, BLayout::RowMajor, 1, 16, SLayout::ColMajor, 512, PadValue::Null> v34;
  TASSIGN(v34, v13);
  Tile<TileType::Right, bfloat16_t, 1, 16, BLayout::RowMajor, 1, 16, SLayout::ColMajor, 512, PadValue::Null> v35;
