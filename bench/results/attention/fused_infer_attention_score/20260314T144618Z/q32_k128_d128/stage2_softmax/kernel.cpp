...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  for (int32_t v41 = v19; v41 < ((uint32_t) v20 < (uint32_t) v7 ? v20 : v7); v41 += v8) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND> v44 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND>(v1 + (v4 + (unsigned) v41 * (unsigned) v6 + v4 * (unsigned) v8), v42, v43);
