...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  int32_t v20 = v8 / v19;
  int32_t v21 = v8 % v19 != v6 && v8 < v6 == v19 < v6 ? v20 + v9 : v20;
  ...
  TASSIGN(v28, v15);
  Tile<TileType::Vec, float, 1, 128, BLayout::RowMajor, 1, 1, SLayout::NoneBox, 512, PadValue::Null> v29;
  TASSIGN(v29, v16);
  set_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
  for (size_t v30 = (size_t) v22; v30 < ((size_t) ((uint32_t) v23 < (uint32_t) v8 ? v23 : v8)); v30 += (size_t) v9) {
    pto::Shape<1, 1, 1, 1, 128> v31 = pto::Shape<1, 1, 1, 1, 128>();
    pto::Stride<128, 128, 128, 128, 1> v32 = pto::Stride<128, 128, 128, 128, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND> v33 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND>(v1 + (v5 + (unsigned) ((int32_t) v30) * (unsigned) v7 + v5 * (unsigned) v9), v31, v32);
