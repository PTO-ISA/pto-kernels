...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  TASSIGN(v24, v11);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 64, SLayout::NoneBox, 512, PadValue::Null> v25;
  TASSIGN(v25, v12);
  ...
  TASSIGN(v27, v14);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 1, SLayout::NoneBox, 512, PadValue::Null> v28;
  TASSIGN(v28, v15);
  ...
  for (size_t v29 = (size_t) v21; v29 < ((size_t) ((uint32_t) v22 < (uint32_t) v7 ? v22 : v7)); v29 += (size_t) v8) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v32 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v1 + (v5 + (unsigned) ((int32_t) v29) * (unsigned) v7 + v5 * (unsigned) v8), v30, v31);
