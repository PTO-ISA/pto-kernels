...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  int32_t v21 = v8 / v20;
  int32_t v22 = v8 % v20 != v6 && v8 < v6 == v20 < v6 ? v21 + v10 : v21;
  ...
  TASSIGN(v29, v16);
  Tile<TileType::Vec, float, 1, 128, BLayout::RowMajor, 1, 8, SLayout::NoneBox, 512, PadValue::Null> v30;
  TASSIGN(v30, v17);
  set_flag(PIPE_MTE3, PIPE_MTE2, EVENT_ID0);
  for (size_t v31 = (size_t) v23; v31 < ((size_t) ((uint32_t) v24 < (uint32_t) v8 ? v24 : v8)); v31 += (size_t) v10) {
    pto::Shape<1, 1, 1, 1, 128> v32 = pto::Shape<1, 1, 1, 1, 128>();
    pto::Stride<128, 128, 128, 128, 1> v33 = pto::Stride<128, 128, 128, 128, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND> v34 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND>(v1 + (v5 + (unsigned) ((int32_t) v31) * (unsigned) v7 + v5 * (unsigned) v10), v32, v33);
    ...
    TROWMAX(v30, v27, v28);
    pipe_barrier(PIPE_V);
    TROWEXPANDSUB(v28, v27, v30);
    pipe_barrier(PIPE_V);
    TEXP(v28, v28);
    pipe_barrier(PIPE_V);
    TROWSUM(v30, v28, v29);
    pipe_barrier(PIPE_V);
    TROWEXPANDDIV(v29, v28, v30);
    pipe_barrier(PIPE_V);
    TCVT(v26, v29, v2);
