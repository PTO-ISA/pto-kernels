...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  TASSIGN(v28, v15);
  Tile<TileType::Vec, float, 1, 16, BLayout::RowMajor, 1, 8, SLayout::NoneBox, 512, PadValue::Null> v29;
  TASSIGN(v29, v16);
  ...
  for (size_t v30 = (size_t) v22; v30 < ((size_t) ((uint32_t) v23 < (uint32_t) v8 ? v23 : v8)); v30 += (size_t) v9) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND> v33 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND>(v1 + (v5 + (unsigned) ((int32_t) v30) * (unsigned) v8 + v5 * (unsigned) v9), v31, v32);
