...
__global__ AICORE void dense_attention_row_softmax(__gm__ half* v1) {
  ...
  TASSIGN(v29, v31);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 64, SLayout::NoneBox, 512, PadValue::Null> v32;
  TASSIGN(v32, v12);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 64, SLayout::NoneBox, 512, PadValue::Null> v33;
  __ubuf__ float* v34 = v32.data();
  uint64_t v35 = reinterpret_cast<uint64_t>(v34);
  TASSIGN(v33, v35);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 64, SLayout::NoneBox, 512, PadValue::Null> v36;
  TASSIGN(v36, v13);
  ...
  TASSIGN(v37, v39);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 64, SLayout::NoneBox, 512, PadValue::Null> v40;
  TASSIGN(v40, v14);
  ...
  TASSIGN(v44, v15);
  Tile<TileType::Vec, float, 1, 64, BLayout::RowMajor, 1, 1, SLayout::NoneBox, 512, PadValue::Null> v45;
  ...
  for (int32_t v52 = v22; v52 < ((uint32_t) v23 < (uint32_t) v7 ? v23 : v7); v52 += v8) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v55 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v1 + (v5 + (unsigned) v52 * (unsigned) v7 + v5 * (unsigned) v8), v53, v54);
