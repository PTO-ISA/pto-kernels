...
__global__ AICORE void grouped_matmul_dense_bf16_bf16(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3, int32_t v4) {
  ...
  for (int32_t v45 = (int32_t) v23; v45 < v18; v45 += (int32_t) v24) {
    int32_t v46 = v45 / v18;
    int32_t v47 = v45 % v18;
    int32_t v48 = (int32_t) ((uint32_t) v46 * (uint32_t) v20);
    int32_t v49 = v46 == v13 ? (int32_t) ((uint32_t) v20 - (uint32_t) v48) : v20;
    int32_t v50 = v47 / v49;
    int32_t v51 = (int32_t) ((uint32_t) (v46 % v20 == v14 ? (int32_t) ((uint32_t) ((int32_t) (uint32_t) v19 - (uint32_t) v50) - (uint32_t) v14) : v50) * (uint32_t) v17);
    int32_t v52 = (int32_t) ((uint32_t) ((int32_t) (uint32_t) v48 + (uint32_t) (v47 % v49)) * (uint32_t) v15);
