...
__global__ AICORE void grouped_matmul_dense_bf16_bf16(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3, int32_t v4) {
  ...
  Tile<TileType::Mat, bfloat16_t, 16, 64, BLayout::ColMajor, 16, 64, SLayout::RowMajor, 512, PadValue::Null> v38;
  TASSIGN(v38, v34);
  Tile<TileType::Mat, bfloat16_t, 64, 128, BLayout::ColMajor, 64, 128, SLayout::RowMajor, 512, PadValue::Null> v39;
  TASSIGN(v39, v35);
  Tile<TileType::Left, bfloat16_t, 16, 64, BLayout::RowMajor, 16, 64, SLayout::RowMajor, 512, PadValue::Null> v40;
  TASSIGN(v40, v34);
  Tile<TileType::Right, bfloat16_t, 64, 128, BLayout::RowMajor, 64, 128, SLayout::ColMajor, 512, PadValue::Null> v41;
  TASSIGN(v41, v34);
  ...
  for (size_t v43 = (size_t) ((int32_t) (int64_t) v36); v43 < ((size_t) v18); v43 += (size_t) ((int32_t) (int64_t) v37)) {
    ...
    bool v58 = v44 == v32;
    bool v59 = v44 == v33;
    int32_t v60 = (int32_t) ((uint32_t) (v59 ? v25 : v58 ? v24 : (v57 ? v23 : v56 ? v22 : (v55 ? v21 : v54 ? v20 : (v53 ? v15 : v52 ? v14 : (v51 ? v25 : v50 ? v24 : (v49 ? v23 : v48 ? v22 : (v47 ? v21 : v46 ? v20 : v45))))))) * (uint32_t) v18);
    ...
    for (size_t v62 = (size_t) v14; v62 < ((size_t) v20); v62 += (size_t) v15) {
      ...
      GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND> v67 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND>(v2 + (v13 + (unsigned) v60 * (unsigned) v16 + (unsigned) v64 * (unsigned) v15), v65, v66);
      pto::Shape<1, 1, 1, 64, 128> v68 = pto::Shape<1, 1, 1, 64, 128>();
      pto::Stride<16384, 16384, 16384, 256, 1> v69 = pto::Stride<16384, 16384, 16384, 256, 1>();
      GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<16384, 16384, 16384, 256, 1>, pto::Layout::ND> v70 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 128>, pto::Stride<16384, 16384, 16384, 256, 1>, pto::Layout::ND>(v3 + (v13 + (unsigned) v64 * (unsigned) v17 + (unsigned) v61 * (unsigned) v15), v68, v69);
