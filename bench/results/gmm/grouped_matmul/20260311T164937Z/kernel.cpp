...
using namespace pto;
__global__ AICORE void grouped_matmul_dense_bf16_f32(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3, int32_t v4) {
  unsigned v5 = 4096;
  unsigned v6 = 16384;
  unsigned v7 = 32;
  unsigned v8 = 128;
  ...
  GlobalTensor<float, pto::Shape<1, 1, 1, 128, 128>, pto::Stride<16384, 16384, 16384, 128, 1>, pto::Layout::ND> v34 = GlobalTensor<float, pto::Shape<1, 1, 1, 128, 128>, pto::Stride<16384, 16384, 16384, 128, 1>, pto::Layout::ND>(v1 + (v10 + v10 * (unsigned) v13 + v10 * (unsigned) v12), v32, v33);
  TSTORE(v34, v22);
