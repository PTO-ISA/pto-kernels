...
__global__ AICORE void grouped_matmul_dense_bf16_bf16(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3, int32_t v4) {
  ...
  for (int32_t v48 = (int32_t) v26; v48 < v21; v48 += (int32_t) v27) {
    int32_t v49 = v48 / v18;
    int32_t v50 = v48 % v18;
    int32_t v51 = (int32_t) ((uint32_t) v49 * (uint32_t) v23);
    int32_t v52 = v49 == v15 ? (int32_t) ((uint32_t) v22 - (uint32_t) v51) : v23;
    int32_t v53 = v50 / v52;
    int32_t v54 = (int32_t) ((uint32_t) ((int32_t) (uint32_t) v51 + (uint32_t) (v50 % v52)) * (uint32_t) v18);
    int32_t v55 = (int32_t) ((uint32_t) (v49 % v20 == v15 ? (int32_t) ((uint32_t) ((int32_t) (uint32_t) v23 - (uint32_t) v53) - (uint32_t) v15) : v53) * (uint32_t) v19);
