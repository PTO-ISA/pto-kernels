...
__global__ AICORE void grouped_matmul_add_add_stage(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3) {
  ...
  TASSIGN(v22, v24);
  Tile<TileType::Vec, float, 1, 128, BLayout::RowMajor, 1, 128, SLayout::NoneBox, 512, PadValue::Null> v25;
  TASSIGN(v25, v12);
  Tile<TileType::Vec, float, 1, 128, BLayout::RowMajor, 1, 128, SLayout::NoneBox, 512, PadValue::Null> v26;
  ...
  TASSIGN(v29, v13);
  Tile<TileType::Vec, float, 1, 128, BLayout::RowMajor, 1, 128, SLayout::NoneBox, 512, PadValue::Null> v30;
  ...
  for (int32_t v33 = v19; v33 < ((uint32_t) v20 < (uint32_t) v9 ? v20 : v9); v33 += v10) {
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND> v36 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND>(v2 + (v6 + (unsigned) v33 * (unsigned) v8 + v6 * (unsigned) v10), v34, v35);
    pto::Shape<1, 1, 1, 1, 128> v37 = pto::Shape<1, 1, 1, 1, 128>();
    pto::Stride<128, 128, 128, 128, 1> v38 = pto::Stride<128, 128, 128, 128, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND> v39 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND>(v3 + (v6 + (unsigned) v33 * (unsigned) v8 + v6 * (unsigned) v10), v37, v38);
    pto::Shape<1, 1, 1, 1, 128> v40 = pto::Shape<1, 1, 1, 1, 128>();
    pto::Stride<128, 128, 128, 128, 1> v41 = pto::Stride<128, 128, 128, 128, 1>();
    GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND> v42 = GlobalTensor<float, pto::Shape<1, 1, 1, 1, 128>, pto::Stride<128, 128, 128, 128, 1>, pto::Layout::ND>(v1 + (v6 + (unsigned) v33 * (unsigned) v8 + v6 * (unsigned) v10), v40, v41);
