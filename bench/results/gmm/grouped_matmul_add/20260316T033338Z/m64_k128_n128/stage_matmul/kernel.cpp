...
__global__ AICORE void grouped_matmul_add_matmul_stage(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3, int32_t v4) {
  ...
  for (int32_t v44 = (int32_t) v22; v44 < v18; v44 += (int32_t) v23) {
    int32_t v45 = v44 / v19;
    int32_t v46 = v44 % v19;
    int32_t v47 = (int32_t) ((uint32_t) v45 * (uint32_t) v17);
    int32_t v48 = v45 == v13 ? (int32_t) ((uint32_t) v19 - (uint32_t) v47) : v17;
    int32_t v49 = v46 / v48;
    int32_t v50 = (int32_t) ((uint32_t) ((int32_t) (uint32_t) v47 + (uint32_t) (v46 % v48)) * (uint32_t) v16);
    int32_t v51 = (int32_t) ((uint32_t) (v45 % v17 == v13 ? (int32_t) ((uint32_t) ((int32_t) (uint32_t) v17 - (uint32_t) v49) - (uint32_t) v13) : v49) * (uint32_t) v14);
    ...
    for (int32_t v52 = v12; v52 < v17; v52 += v13) {
      ...
      GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND> v56 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND>(v2 + (v11 + (unsigned) v50 * (unsigned) v15 + (unsigned) v53 * (unsigned) v13), v54, v55);
      pto::Shape<1, 1, 1, 64, 64> v57 = pto::Shape<1, 1, 1, 64, 64>();
      pto::Stride<8192, 8192, 8192, 128, 1> v58 = pto::Stride<8192, 8192, 8192, 128, 1>();
      GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 64>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND> v59 = GlobalTensor<bfloat16_t, pto::Shape<1, 1, 1, 64, 64>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND>(v3 + (v11 + (unsigned) v53 * (unsigned) v15 + (unsigned) v51 * (unsigned) v13), v57, v58);
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND> v62 = GlobalTensor<float, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND>(v1 + (v11 + (unsigned) v50 * (unsigned) v15 + (unsigned) v51 * (unsigned) v13), v60, v61);
