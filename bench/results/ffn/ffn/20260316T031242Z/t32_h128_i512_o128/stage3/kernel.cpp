...
__global__ AICORE void _stage(__gm__ half* v1, __gm__ half* v2, __gm__ half* v3) {
  ...
  for (int32_t v47 = (int32_t) v25; v47 < v12; v47 += (int32_t) v26) {
    bool v48 = v47 == v21;
    bool v49 = v47 == v22;
    ...
    for (int32_t v52 = v20; v52 < v13; v52 += v19) {
      ...
      pto::Stride<8192, 8192, 8192, 512, 1> v55 = pto::Stride<8192, 8192, 8192, 512, 1>();
      GlobalTensor<half, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<8192, 8192, 8192, 512, 1>, pto::Layout::ND> v56 = GlobalTensor<half, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<8192, 8192, 8192, 512, 1>, pto::Layout::ND>(v2 + (v11 + (unsigned) v50 * (unsigned) v17 + (unsigned) v53 * (unsigned) v19), v54, v55);
      pto::Shape<1, 1, 1, 64, 64> v57 = pto::Shape<1, 1, 1, 64, 64>();
      pto::Stride<8192, 8192, 8192, 128, 1> v58 = pto::Stride<8192, 8192, 8192, 128, 1>();
      GlobalTensor<half, pto::Shape<1, 1, 1, 64, 64>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND> v59 = GlobalTensor<half, pto::Shape<1, 1, 1, 64, 64>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND>(v3 + (v11 + (unsigned) v53 * (unsigned) v16 + (unsigned) v51 * (unsigned) v19), v57, v58);
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND> v62 = GlobalTensor<half, pto::Shape<1, 1, 1, 16, 64>, pto::Stride<2048, 2048, 2048, 128, 1>, pto::Layout::ND>(v1 + (v11 + (unsigned) v50 * (unsigned) v16 + (unsigned) v51 * (unsigned) v19), v60, v61);
