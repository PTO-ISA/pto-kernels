...
__global__ AICORE void dense_relu_stage(__gm__ half* v1) {
  ...
  for (size_t v20 = (size_t) v16; v20 < ((size_t) ((uint32_t) v17 < (uint32_t) v6 ? v17 : v6)); v20 += (size_t) v8) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 512>, pto::Stride<512, 512, 512, 512, 1>, pto::Layout::ND> v23 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 512>, pto::Stride<512, 512, 512, 512, 1>, pto::Layout::ND>(v1 + (v4 + (unsigned) ((int32_t) v20) * (unsigned) v7 + v4 * (unsigned) v8), v21, v22);
