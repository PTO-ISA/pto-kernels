...
__global__ AICORE void moe_token_permute_seed(__gm__ half* v1, __gm__ half* v2, __gm__ int32_t* v3) {
  ...
  TASSIGN(v23, v13);
  Tile<TileType::Vec, half, 1, 512, BLayout::RowMajor, 1, 512, SLayout::NoneBox, 512, PadValue::Null> v24;
  ...
  TASSIGN(v28, v30);
  Tile<TileType::Vec, half, 1, 32, BLayout::RowMajor, 1, 32, SLayout::NoneBox, 512, PadValue::Null> v31;
  TASSIGN(v31, v15);
  ...
  GlobalTensor<half, pto::Shape<1, 1, 1, 1, 512>, pto::Stride<512, 512, 512, 512, 1>, pto::Layout::ND> v37 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 512>, pto::Stride<512, 512, 512, 512, 1>, pto::Layout::ND>(v2 + (v7 + v7 * (unsigned) v12), v35, v36);
  ...
  for (int32_t v38 = v21; v38 < ((uint32_t) v22 < (uint32_t) v11 ? v22 : v11); v38 += v12) {
    ...
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 32>, pto::Stride<32, 32, 32, 32, 1>, pto::Layout::ND> v42 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 32>, pto::Stride<32, 32, 32, 32, 1>, pto::Layout::ND>(v3 + (v7 + (unsigned) v39 * (unsigned) v12), v40, v41);
    pto::Shape<1, 1, 1, 1, 32> v43 = pto::Shape<1, 1, 1, 1, 32>();
    pto::Stride<32, 32, 32, 32, 1> v44 = pto::Stride<32, 32, 32, 32, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 32>, pto::Stride<32, 32, 32, 32, 1>, pto::Layout::ND> v45 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 32>, pto::Stride<32, 32, 32, 32, 1>, pto::Layout::ND>(v1 + (v7 + (unsigned) v39 * (unsigned) v12), v43, v44);
