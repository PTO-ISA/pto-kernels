...
__global__ AICORE void moe_token_permute_seed(__gm__ half* v1, __gm__ half* v2, __gm__ int32_t* v3) {
  ...
  TASSIGN(v22, v12);
  Tile<TileType::Vec, int32_t, 1, 16, BLayout::RowMajor, 1, 16, SLayout::NoneBox, 512, PadValue::Null> v23;
  TASSIGN(v23, v13);
  ...
  GlobalTensor<half, pto::Shape<1, 1, 1, 1, 256>, pto::Stride<256, 256, 256, 256, 1>, pto::Layout::ND> v27 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 256>, pto::Stride<256, 256, 256, 256, 1>, pto::Layout::ND>(v2 + (v7 + v7 * (unsigned) v11), v25, v26);
  ...
  for (size_t v28 = (size_t) v20; v28 < ((size_t) ((uint32_t) v21 < (uint32_t) v10 ? v21 : v10)); v28 += (size_t) v11) {
    ...
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND> v32 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND>(v3 + (v7 + (unsigned) v29 * (unsigned) v11), v30, v31);
    pto::Shape<1, 1, 1, 1, 16> v33 = pto::Shape<1, 1, 1, 1, 16>();
    pto::Stride<16, 16, 16, 16, 1> v34 = pto::Stride<16, 16, 16, 16, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND> v35 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND>(v1 + (v7 + (unsigned) v29 * (unsigned) v11), v33, v34);
