...
__global__ AICORE void moe_token_unpermute_seed(__gm__ half* v1, __gm__ half* v2, __gm__ int32_t* v3) {
  ...
  TASSIGN(v23, v13);
  Tile<TileType::Vec, half, 1, 16384, BLayout::RowMajor, 1, 16384, SLayout::NoneBox, 512, PadValue::Null> v24;
  ...
  TASSIGN(v27, v14);
  Tile<TileType::Vec, int32_t, 1, 64, BLayout::RowMajor, 1, 64, SLayout::NoneBox, 512, PadValue::Null> v28;
  ...
  TASSIGN(v32, v34);
  pto::Shape<1, 1, 1, 1, 16384> v35 = pto::Shape<1, 1, 1, 1, 16384>();
  pto::Stride<16384, 16384, 16384, 16384, 1> v36 = pto::Stride<16384, 16384, 16384, 16384, 1>();
  GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16384>, pto::Stride<16384, 16384, 16384, 16384, 1>, pto::Layout::ND> v37 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16384>, pto::Stride<16384, 16384, 16384, 16384, 1>, pto::Layout::ND>(v2 + (v7 + v7 * (unsigned) v12), v35, v36);
  ...
  for (int32_t v38 = v21; v38 < ((uint32_t) v22 < (uint32_t) v11 ? v22 : v11); v38 += v12) {
    ...
    GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v42 = GlobalTensor<int32_t, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v3 + (v7 + (unsigned) v39 * (unsigned) v12), v40, v41);
    pto::Shape<1, 1, 1, 1, 64> v43 = pto::Shape<1, 1, 1, 1, 64>();
    pto::Stride<64, 64, 64, 64, 1> v44 = pto::Stride<64, 64, 64, 64, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v45 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v1 + (v7 + (unsigned) v39 * (unsigned) v12), v43, v44);
