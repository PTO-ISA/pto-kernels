...
__global__ AICORE void moe_gating_top_k_softmax_stage(__gm__ half* v1, __gm__ half* v2) {
  ...
  TASSIGN(v26, v11);
  Tile<TileType::Vec, half, 1, 16, BLayout::RowMajor, 1, 16, SLayout::NoneBox, 512, PadValue::Null> v27;
  ...
  TASSIGN(v34, v13);
  Tile<TileType::Vec, half, 1, 16, BLayout::RowMajor, 1, 1, SLayout::NoneBox, 512, PadValue::Null> v35;
  ...
  for (int32_t v42 = v20; v42 < ((uint32_t) v21 < (uint32_t) v8 ? v21 : v8); v42 += v9) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND> v45 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND>(v2 + (v5 + (unsigned) v42 * (unsigned) v7 + v5 * (unsigned) v9), v43, v44);
    pto::Shape<1, 1, 1, 1, 16> v46 = pto::Shape<1, 1, 1, 1, 16>();
    pto::Stride<16, 16, 16, 16, 1> v47 = pto::Stride<16, 16, 16, 16, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND> v48 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 16>, pto::Stride<16, 16, 16, 16, 1>, pto::Layout::ND>(v1 + (v5 + (unsigned) v42 * (unsigned) v7 + v5 * (unsigned) v9), v46, v47);
