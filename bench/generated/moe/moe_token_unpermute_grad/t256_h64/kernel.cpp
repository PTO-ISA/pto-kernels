...
using namespace pto;
__global__ AICORE void moe_token_unpermute_grad_seed(__gm__ half* v1, __gm__ half* v2, __gm__ half* v3, __gm__ int32_t* v4) {
  unsigned v5 = 64;
  unsigned v6 = 1;
  unsigned v7 = 0;
  int32_t v8 = 64;
  ...
  for (size_t v23 = (size_t) v20; v23 < ((size_t) ((uint32_t) v21 < (uint32_t) v9 ? v21 : v9)); v23 += (size_t) v10) {
    ...
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v27 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v3 + (v7 + (unsigned) ((int32_t) v23) * (unsigned) v8 + v7 * (unsigned) v10), v25, v26);
    pto::Shape<1, 1, 1, 1, 64> v28 = pto::Shape<1, 1, 1, 1, 64>();
    pto::Stride<64, 64, 64, 64, 1> v29 = pto::Stride<64, 64, 64, 64, 1>();
    GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND> v30 = GlobalTensor<half, pto::Shape<1, 1, 1, 1, 64>, pto::Stride<64, 64, 64, 64, 1>, pto::Layout::ND>(v1 + (v7 + (unsigned) v24 * (unsigned) v8 + v7 * (unsigned) v10), v28, v29);
