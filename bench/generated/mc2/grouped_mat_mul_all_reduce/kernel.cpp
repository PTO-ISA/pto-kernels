...
__global__ AICORE void grouped_mat_mul_all_reduce_local(__gm__ half* v1, __gm__ half* v2, __gm__ half* v3) {
  ...
  if (v25 < v11) {
    ...
    for (size_t v31 = v22; v31 < ((size_t) v12); v31 += v23) {
      int32_t v32 = (int32_t) ((uint32_t) ((int32_t) v31) + (uint32_t) (v25 / v11));
      if (v32 < v12) {
        int32_t v33 = (int32_t) ((uint32_t) v32 * (uint32_t) v15);
        int32_t v34 = (int32_t) ((uint32_t) (v25 % v11) * (uint32_t) v15);
        ...
        for (size_t v35 = v22; v35 < ((size_t) v13); v35 += v23) {
          ...
          GlobalTensor<half, pto::Shape<1, 1, 1, 32, 64>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND> v40 = GlobalTensor<half, pto::Shape<1, 1, 1, 32, 64>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND>(v2 + (v10 + (unsigned) v33 * (unsigned) v16 + (unsigned) v37 * (unsigned) v18), v38, v39);
          pto::Shape<1, 1, 1, 64, 32> v41 = pto::Shape<1, 1, 1, 64, 32>();
          pto::Stride<8192, 8192, 8192, 128, 1> v42 = pto::Stride<8192, 8192, 8192, 128, 1>();
          GlobalTensor<half, pto::Shape<1, 1, 1, 64, 32>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND> v43 = GlobalTensor<half, pto::Shape<1, 1, 1, 64, 32>, pto::Stride<8192, 8192, 8192, 128, 1>, pto::Layout::ND>(v3 + (v10 + (unsigned) v37 * (unsigned) v16 + (unsigned) v34 * (unsigned) v18), v41, v42);
        ...
        GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND> v46 = GlobalTensor<half, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<4096, 4096, 4096, 128, 1>, pto::Layout::ND>(v1 + (v10 + (unsigned) v33 * (unsigned) v16 + (unsigned) v34 * (unsigned) v18), v44, v45);
