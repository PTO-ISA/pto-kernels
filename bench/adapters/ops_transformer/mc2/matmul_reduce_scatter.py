...
def describe(repo_root, spec):
    return describe_baseline(repo_root, "mc2", "matmul_reduce_scatter", spec.inventory_ref)


def compile_kernel(repo_root, spec, artifacts_dir):
    return blocked("Capture ops-transformer compile/run flow for matmul_reduce_scatter.")
