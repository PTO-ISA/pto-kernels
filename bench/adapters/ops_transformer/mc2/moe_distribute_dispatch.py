...
def describe(repo_root, spec):
    summary = describe_baseline(repo_root, "mc2", "moe_distribute_dispatch", spec.inventory_ref)
    summary["runtime_entrypoint"] = "torch_npu.npu_moe_distribute_dispatch"
...
def benchmark(repo_root, spec, artifacts_dir):
    ...
    report_path = Path(artifacts_dir) / "ops_transformer_moe_distribute_dispatch_benchmark.json"
