...
from pto_kernels.ops.posembedding.rope_quant_kvcache.runtime import VARIANTS, make_inputs, run_pto_variant


KERNEL = "python/pto_kernels/ops/posembedding/rope_quant_kvcache/kernel.py"
META = "python/pto_kernels/ops/posembedding/rope_quant_kvcache/meta.py"
...
def benchmark(repo_root, spec, artifacts_dir):
    try:
        ...
        for variant in VARIANTS:
            ...
            spec_obj = importlib.util.spec_from_file_location(f"pto_rope_quant_kvcache_kernel_{variant.label}", kernel_file)
        ...
        report_path = Path(artifacts_dir) / "ptodsl_rope_quant_kvcache_benchmark.json"
