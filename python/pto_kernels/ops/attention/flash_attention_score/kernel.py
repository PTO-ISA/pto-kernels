...
from pto_kernels.ops.attention.common import (
    DenseAttentionConfig,
    DenseAttentionPipelineWrapper,
)
...
def _config() -> DenseAttentionConfig:
    ...
    return DenseAttentionConfig(
        ...
        qk_block_dim=tuned_int(
            "PTO_ATTENTION_QK_BLOCK_DIM", 8, valid_values=(1, 2, 4, 8, 16, 20)
        ),
        ...
        pv_block_dim=tuned_int(
            "PTO_ATTENTION_PV_BLOCK_DIM", 8, valid_values=(1, 2, 4, 8, 16, 20)
        ),
        softmax_block_dim=tuned_int(
            "PTO_ATTENTION_SOFTMAX_BLOCK_DIM", 8, valid_values=(1, 2, 4, 8, 16, 20)
        ),
    )
